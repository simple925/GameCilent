...
int AGraphicShader::CreateVertexShader(const wstring& _RelativeFilePath, const string& _FuncName)
{
	...
	// [3] NORMAL 추가
	InputDesc[3].SemanticName = "NORMAL";
	InputDesc[3].SemanticIndex = 0;
	InputDesc[3].AlignedByteOffset = 36; // 앞선 데이터들의 크기 합 (12 + 8 + 16 = 36)
	...
	// CreateInputLayout 호출 시 개수를 4로 수정
	if (FAILED(DEVICE->CreateInputLayout(InputDesc, 4
